...
class ChemicalEquationApp:
    ...
    def create_control_panel(self):
        ...
        self.home_btn.grid(row=4, column=0, pady=(20, 5), sticky=tk.EW)

        # 退出按钮
        self.exit_btn = ttk.Button(control_frame, text="退出程序",
                                   command=self.root.quit)
        self.exit_btn.grid(row=5, column=0, pady=5, sticky=tk.EW)

        # 设置控制面板列权重
        control_frame.columnconfigure(0, weight=1)
        control_frame.rowconfigure(6, weight=1)  # 添加弹性空间
    ...
    def create_image_display(self):
        ...
        # 创建Canvas用于显示图片
        self.image_canvas = tk.Canvas(image_frame, width=500, height=300, bg='white')  # 高度减少
    ...
    def create_result_display(self):
        ...
        self.latex_text = tk.Text(result_frame, height=4, width=80,  # 增加高度
    ...
    def display_image(self, img_path):
        ...
        try:
            ...
            img.thumbnail((500, 300), Image.Resampling.LANCZOS)  # 适配新的Canvas大小
            ...
            self.image_canvas.create_image(250, 150, image=self.photo, anchor=tk.CENTER)  # 调整中心点
            self.image_label.config(text="原始图片")
    ...
    def display_processed_image(self, cv2_img):
        ...
        try:
            ...
            pil_img.thumbnail((500, 300), Image.Resampling.LANCZOS)  # 适配新的Canvas大小
            ...
            # 在Canvas上显示
            self.image_canvas.delete("all")
            self.image_canvas.create_image(250, 150, image=self.processed_photo, anchor=tk.CENTER)  # 调整中心点
    ...
    def generate_latex_image(self, latex_str):
        ...
        try:
            ...
            if canvas_width < 10 or canvas_height < 10:  # 如果Canvas还没有大小
    ...
    def display_latex_image_in_canvas(self):
        ...
        display_height = min(canvas_height - 20, img_height)  # 留出边距
